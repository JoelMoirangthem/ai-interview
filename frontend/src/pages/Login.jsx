      ...
      >
        ...
        <div className="glass-strong rounded-3xl p-8 shadow-2xl">
          <div className="text-center mb-7">
            ...
            <p className="text-sm text-white/50 mt-1.5">Sign in to continue your prep</p>
          </div>
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2.5 h-11 px-4 rounded-xl bg-white text-[#1f1f1f] text-sm font-medium hover:bg-white/90 transition-all disabled:opacity-50 mb-5"
          >
            {googleLoading ? (
